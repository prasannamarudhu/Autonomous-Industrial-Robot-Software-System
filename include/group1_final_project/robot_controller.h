...
public:
    ...
    bool PickPart(geometry_msgs::Pose& part_pose,std::string product_type,int OnConveyor);
...
private:
    ...
    std::string object;
    bool plan_success_;
    std::vector<double> home_joint_pose_, agv_drop_position_,initial_home_joint_pose_;
